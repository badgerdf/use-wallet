...
function _init$9() {
  _init$9 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    var _yield$import, DeFiWeb3Connector;
    ...
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return import('deficonnect');

          case 2:
            _yield$import = _context.sent;
            DeFiWeb3Connector = _yield$import.DeFiWeb3Connector;
            return _context.abrupt("return", {
              web3ReactConnector: function web3ReactConnector(_ref) {
                var chainId = _ref.chainId,
                    rpc = _ref.rpc;
...
var BASE_URL = 'https://storageapi.fleek.co/aragonone-team-bucket/wallet-icons'; // See the corresponding prop type, EthereumProviderType, in prop-types.js.
